...
def investment_type_templates() -> dict[str, InvestmentType]:
    templates = [
        _template(
            ...
            description="원금 변동을 낮추고 현금과 채권 비중을 높게 유지하는 방어형 정책입니다.",
        ...
        _template(
            ...
            description="상대 강도와 추세를 반영해 성장 자산 비중을 탄력적으로 조정합니다.",
            suitable_horizon="3년 이상",
            risk_level="high",
        ...
        _template(
            ...
            description="리스크 패리티와 최소 변동성 선호를 결합한 정량 균형 배분을 추구합니다.",
            suitable_horizon="3년 이상",
            risk_level="medium",
