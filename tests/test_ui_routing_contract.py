...
class UiRoutingContractTests(unittest.TestCase):
    ...
    def test_ai_portfolio_ui_module_contract(self):
        ...
        self.assertIn('src="app.js?v=20260520-universe-v1"', html)
    ...
    def test_cross_dashboard_smoke_tracks_current_bundle_and_quantamental(self):
        ...
        self.assertIn('APP_BUNDLE_VERSION = "20260520-universe-v1"', smoke_source)
    ...
    def test_quant_symbol_catalog_expanded_universe_contract(self):
        html = INDEX_HTML.read_text(encoding="utf-8")
        self.assertEqual(self._symbol_list_count("US_LARGE_CAP_SYMBOLS"), 516)
        self.assertEqual(self._symbol_list_count("ETF_CORE_SYMBOLS"), 120)
        ...
        self.assertIn('"SOL-USD"', self.source)
        self.assertIn('"AVAX-USD"', self.source)
        self.assertIn("const GLOBAL_EQUITY_SYMBOLS = [", self.source)
        self.assertIn('"RELIANCE.NS"', self.source)
        ...
        self.assertIn('value="global_equity_core"', html)
        self.assertIn('value="etf_core_120"', html)
